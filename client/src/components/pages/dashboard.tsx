    ...
    <div className="d-flex w-100">
      <div className="d-flex justify-content-center w-100">
        <div className="d-flex flex-column align-content-center">
          <div className="text-center" style={{fontSize: '19px'}}>{widgetTitle}</div>
          <div className="text-truncate text-center" style={{fontSize: '11px', opacity: '0.4', paddingTop: '1px'}}>{widgetName}</div>
        </div>
      </div>
      <div
