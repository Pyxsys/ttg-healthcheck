...
describe("2. Devices Page tabs.", () => {
  ...
  it("2.1 Make sure that all 5 device details tabs are being displayed.", () => {
    ...
    cy.get('div[class="device-details-tabs col"] > ul').find('li').should('have.length', 5);
  ...
  it("2.2 Make sure that when the a tab is clicked on the relevant information cards are displayed.", () => {
    loginAndDevicesPage();
    cy.wait(500);
    // navigate to device detail page
